...
pub impl ByteSpanImpl of ByteSpanTrait {
    ...
    /// Option<u8>).
    fn get<I, impl TSliceIndex: crate::ops::SliceIndex<ByteSpan, I>, +Drop<I>>(
        self: @ByteSpan, index: I,
    ) -> Option<TSliceIndex::Output> {
        TSliceIndex::get(self, index)
    }
}
...
impl ByteSpanSliceIndexRange of crate::ops::SliceIndex<ByteSpan, crate::ops::Range<usize>> {
...
impl ByteSpanSliceIndexRangeInclusive of crate::ops::SliceIndex<
